...
class HelloArRenderer(val activity: VIOActivity) :
  ...
  override fun onDrawFrame(render: SampleRender) {
    ...
    activity.runOnUiThread {
      val vioData = camera.displayOrientedPose
      val vioString = "${vioData.tx()}" //todo: Vio 파싱
      activity.updateVIOString(camera.displayOrientedPose.toString())
    }
